...
export default function ReturnsForm(){
  ...
  async function handleSubmit(e: React.FormEvent){
    ...
    try {
      ...
      if(json.ok){ setStatus('Request submitted. We\'ll email you within 24h.'); (e.currentTarget as HTMLFormElement).reset(); } else { setStatus(json.error||'Submission failed.'); }
