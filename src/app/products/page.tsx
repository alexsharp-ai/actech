  ...
  return (
    <div className="bg-white text-black w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-16">
        ...
        {featured && (
          <div className="bg-white rounded-lg border border-gray-200 p-6 flex flex-col shadow-sm hover:shadow-md transition">
            ...
            <p className="text-sm text-gray-600 mb-4 flex-1">{featured.subtitle}</p>
            <Link href={`/product/${featured.slug}`} className="inline-block bg-black hover:bg-gray-800 transition text-white font-semibold px-5 py-3 rounded text-center">View product</Link>
          </div>
        )}
        </div>
      </div>
